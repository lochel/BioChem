within BioChem.Examples.CellDivison;
model cell
  ...
  CellDivison.cell.Reaction8_ Reaction8
    "cdc2 kinase triggered degration of cyclin"                                     annotation(Placement(transformation(origin={-30.0,20.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-270)));
      ...
      <bqbiol:is>
        <rdf:Bag>
          <rdf:li rdf:resource=\"urn:miriam:obo.go:GO%3A0005623\"/>
            ...
            experiment(StartTime=0.0, StopTime=100, NumberOfIntervals=-1, Algorithm="dassl", Tolerance=1e-06), Documentation(info="<html>
<h1>CellDivision</h1>
