...
model cell "cell"
  ...
  BioChem.Examples.GMO.cell.reaction2_ reaction2
    "default degradation of cyclin"                                              annotation(Placement(transformation(origin={30.0,-60.0}, extent={{-10.0,10.0},{10.0,-10.0}}, rotation=180)));
  BioChem.Examples.GMO.cell.reaction3_ reaction3
    "cdc2 kinase triggered degration of cyclin"                                              annotation(Placement(transformation(origin={50.0,10.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-180)));
  BioChem.Examples.GMO.cell.reaction4_ reaction4(V1=V1)
    "activation of cdc2 kinase"                                                     annotation(Placement(transformation(origin={-70.0,40.0}, extent={{10.0,-10.0},{-10.0,10.0}}, rotation=270)));
  ...
  BioChem.Examples.GMO.cell.reaction6_ reaction6(V3=V3)
    "activation of cyclin protease"                                                     annotation(Placement(transformation(origin={10.0,-37.8911}, extent={{-10.0,-10.0},{10.0,10.0}})));
  BioChem.Examples.GMO.cell.reaction7_ reaction7
    "deactivation of cyclin protease"                                              annotation(Placement(transformation(origin={20.0,-10.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-180)));
equation
...
<img src=\"modelica://BioChem/Resources/Images/Cell.png\" alt=\"Fig1: Simulation results\">
      ...
      revisions=""), experiment(StartTime=0.0, StopTime=100, NumberOfIntervals=-1, Algorithm="dassl", Tolerance=1e-06));
end cell;
