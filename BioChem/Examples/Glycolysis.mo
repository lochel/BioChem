...
model Glycolysis "Glycolysis"
  ...
  Substances.Substance PEP1(c(
                            start = 0)) "Phosphoenol pyruvate"
                                                              annotation(Placement(transformation(origin={2.96307e-12,-108.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-270)));
  ...
  Substances.Substance G13BP(c(
                             start = 0)) "Glycerate-1,3-bisphosphate"
                                                                     annotation(Placement(transformation(origin={1.16462e-13,-18.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-270)));
  ...
  Substances.Substance G2P1(c(
                            start = 0)) "Glycerate-2-phosphate"
                                                               annotation(Placement(transformation(origin={1.03362e-13,-78.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-630)));
  ...
  Substances.Substance GA3P(c(
                            start = 0)) "Glycerate-3-phosphate"
                                                               annotation(Placement(transformation(origin={1.06248e-13,-48.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-270)));
  ...
  Substances.Substance Glucose(c(
                               start = 1)) "Glucose"
                                                    annotation(Placement(transformation(origin={3.32706e-16,139.222}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-270)));
  Substances.Substance G6P(c(
                           start = 0)) "Glucose-6-phosphate"
                                                            annotation(Placement(transformation(origin={1.13798e-13,108.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-270)));
  Substances.Substance F6P(c(
                           start = 0)) "Fructose-6-phosphate"
                                                             annotation(Placement(transformation(origin={2.39286e-12,78.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-630)));
  Substances.Substance F16BP(c(
                             start = 0)) "Fructose-1,6-bisphosphate"
                                                                    annotation(Placement(transformation(origin={1.13354e-13,48.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-270)));
  Substances.Substance G3P(c(
                           start = 0)) "Glyceraldehyde-3-phosphate"
                                                                   annotation(Placement(transformation(origin={-15,18.75}, extent={{-7.5,-7.5},{7.5,7.5}})));
...
<h1>Glycolysis</h1>
 ...
 to obtain a fully functional model, realistic parameter values must be used.
         ...
         revisions=""), Icon(coordinateSystem(extent={{-100,100},{100,-100}}, preserveAspectRatio=true, grid={10,10}), graphics={Line(points={{0,100},{0,25},{-25,0},{0,-25},{0,-75},{-25,-100}}),Line(points={{0,25},{25,0},{-25,0}}),Line(points={{0,-75},{25,-100}})}), Diagram(coordinateSystem(extent={{-105,148.5},{105,-148.5}}, preserveAspectRatio=true, grid={10,10})));
end Glycolysis;
