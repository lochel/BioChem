...
model Hillmmr "Reversible Hill kinetics with two modifiers"
  ...
  parameter BioChem.Units.Concentration m1Half=1
    "Concentration of m1 that half-saturates its binding site when s1.c = 0, p1.c = 0, m2.c = 0";
  parameter BioChem.Units.Concentration m2Half=1
    "Concentration of m1 that half-saturates its binding site when s1.c = 0, p1.c = 0, m1.c = 0";
  parameter BioChem.Units.Concentration s1Half=1
    "Substrate concentration such that v = vF/2 when p1.c = 0 and the modifiers m1.c = 0, m2.c = 0";
  parameter BioChem.Units.Concentration p1Half=1
    "Product concentration such that v = -vF/2 when p1.c = 0 and the modifiers m1.c = 0, m2.c = 0";
