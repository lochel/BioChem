...
model Hillmr "Reversible Hill kinetics with one modifier"
  ...
  parameter BioChem.Units.Concentration m1Half=1
    "Concentration of mA that half-saturates its binding site when s1.c = 0, p1.c = 0, m2.c = 0";
  parameter BioChem.Units.Concentration s1Half=1
    "Substrate concentration such that v = vF/2";
  parameter BioChem.Units.Concentration p1Half=1
    "Product concentration such that v = -vF/2";
